...
return [
    ...
    'm_room_info' => [
        'columns' => [
            ...
            'facility_id'  => ['type' => 'integer', 'null' => true],
    ...
    'tenants' => [
        'columns' => [
            'id'                  => ['type' => 'integer', 'autoIncrement' => true, 'null' => false],
            'tenant_code'         => ['type' => 'string', 'length' => 50,  'null' => false],
            'name'                => ['type' => 'string', 'length' => 100, 'null' => false],
            'status'              => ['type' => 'string', 'length' => 20,  'null' => false, 'default' => 'trial'],
            'plan_code'           => ['type' => 'string', 'length' => 50,  'null' => true],
            'contract_started_at' => ['type' => 'datetime', 'null' => true],
            'contract_ended_at'   => ['type' => 'datetime', 'null' => true],
            'created_at'          => ['type' => 'datetime', 'null' => false],
            'updated_at'          => ['type' => 'datetime', 'null' => false],
        ],
        'constraints' => [
            'primary'        => ['type' => 'primary',  'columns' => ['id']],
            'uq_tenant_code' => ['type' => 'unique',   'columns' => ['tenant_code']],
        ],
    ],
    'facilities' => [
        'columns' => [
            ...
            'facility_code' => ['type' => 'string', 'length' => 50,  'null' => false],
            'name'          => ['type' => 'string', 'length' => 100, 'null' => false],
            'timezone'      => ['type' => 'string', 'length' => 50,  'null' => false, 'default' => 'Asia/Tokyo'],
