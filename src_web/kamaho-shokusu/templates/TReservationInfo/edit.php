        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <fieldset>
                    ...
                    <?php foreach ($tReservationInfos as $tReservationInfo): ?>
                        <div class="form-group row">
                            <?= $this->Form->label('d_reservation_date', '予約日', ['class' => 'col-sm-3 col-form-label']) ?>
                            <div class="col-sm-9">
                                <?= $this->Form->control("tReservationInfos.{$tReservationInfo->id}.d_reservation_date", [
                                    'type' => 'date',
                                    'label' => false,
                                    'class' => 'form-control',
                                    'disabled' => true,
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <?= $this->Form->control("tReservationInfos.{$tReservationInfo->id}.i_id_room", [
                                    'type' => 'select',
                                    'label' => false,
                                    'options' => $rooms,
                                    'empty' => '-- 部屋を選択 --',
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <?= $this->Form->control("tReservationInfos.{$tReservationInfo->id}.c_reservation_type", [
                                    'label' => false,
                                    'type' => 'select',
                                    'options' => [
                                        1 => '朝',
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <?= $this->Form->control("tReservationInfos.{$tReservationInfo->id}.i_taberu_ninzuu", [
                                    'label' => false,
                                    'class' => 'form-control',
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <?= $this->Form->control("tReservationInfos.{$tReservationInfo->id}.i_tabenai_ninzuu", [
                                    'label' => false,
                                    'class' => 'form-control',
